...
import com.example.heartify.ViewModelFactory
import com.example.heartify.data.UserModel
import com.example.heartify.loginwithanimation.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupAction() {
        binding.loginButton.setOnClickListener {
            ...
            // Jika password valid, lanjutkan dengan login
